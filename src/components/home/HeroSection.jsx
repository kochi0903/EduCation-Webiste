...
import StudentHero from "../../assets/StudentsHero.jpeg";
      ...
      <div className="container relative z-10 pt-20">
        <div className="max-w-3xl">
          ...
          >
            ...
            <span className="text-primary-500">Tomorrow's Leaders</span>
          </motion.h1>
          ...
          >
            Discover our world-class courses designed to help you master new
            skills, advance your career, and achieve your full potential.
          </motion.p>
        ...
        <div className="container">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <motion.div
              ...
              transition={{ duration: 0.6, delay: 0.4 }}
            >
              <div className="text-primary-500 font-bold text-3xl md:text-4xl">
                10+
              </div>
